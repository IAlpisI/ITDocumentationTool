...
namespace IToolAPI.Migrations
{
    ...
    [Migration("20210423192002_hostAddress2")]
    partial class hostAddress2
    {
            ...
            modelBuilder.Entity("IToolAPI.Models.Shared.General", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClinetPcId = 0,
                            CreatioDate = new DateTime(2021, 4, 23, 0, 0, 0, 0, DateTimeKind.Local),
                            Description = "fasfasfsa",
                            ModifiedDate = new DateTime(2021, 4, 23, 0, 0, 0, 0, DateTimeKind.Local),
                            Purpose = "fasfsafsa",
                            Status = "ffasfas",
                            Tag = "[\"test\",\"test\"]",
                            Title = "fafasfas"
            ...
            modelBuilder.Entity("IToolAPI.Models.Shared.HostAddress", b =>
                {
                    b.HasOne("IToolAPI.Models.ClientPc", "ClientPc")
                        .WithOne("HostAddress")
                        .HasForeignKey("IToolAPI.Models.Shared.HostAddress", "ClientId");
