...
namespace IToolAPI.Migrations
{
    ...
    [Migration("20210413134757_removeapplication")]
            ...
            modelBuilder.Entity("IToolAPI.Models.Shared.General", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatioDate = new DateTime(2021, 4, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfChange = new DateTime(2021, 4, 13, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("IToolAPI.Models.Printer", b =>
                {
                    b.HasOne("IToolAPI.Models.Shared.General", "General")
                        .WithOne("Printer")
                        .HasForeignKey("IToolAPI.Models.Printer", "Generald")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
