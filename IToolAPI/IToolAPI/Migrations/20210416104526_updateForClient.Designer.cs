...
namespace IToolAPI.Migrations
{
    ...
    [Migration("20210416104526_updateForClient")]
    partial class updateForClient
    {
            ...
            modelBuilder.Entity("IToolAPI.Models.ClientPc", b =>
                {
                    ...
                    b.HasIndex("MemoryId")
                        .IsUnique()
                        .HasFilter("[MemoryId] IS NOT NULL");

                    b.HasIndex("PowerConsumerId")
                        .IsUnique()
                        .HasFilter("[PowerConsumerId] IS NOT NULL");
            ...
            modelBuilder.Entity("IToolAPI.Models.ClientPc", b =>
                {
                    b.HasOne("IToolAPI.Models.Shared.Cpu", "Cpu")
                        .WithOne("ClientPc")
                        .HasForeignKey("IToolAPI.Models.ClientPc", "CpuId");
                    ...
                    b.HasOne("IToolAPI.Models.Shared.Memory", "Memory")
                        .WithOne("ClientPc")
                        .HasForeignKey("IToolAPI.Models.ClientPc", "MemoryId");

                    b.HasOne("IToolAPI.Models.Shared.PowerConsumer", "PowerConsumer")
                        .WithOne("ClientPc")
                        .HasForeignKey("IToolAPI.Models.ClientPc", "PowerConsumerId");
